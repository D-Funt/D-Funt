...
I don't just write code; I engineer software to solve real-world business bottlenecks. With a background bridging large-scale IT operations (managing infrastructure for 350+ retail locations) and software engineering, I bring an **"Operations-First"** approach to development. I know firsthand how infrastructure scales and fails, which drives me to build resilient, cost-effective, and highly available systems.
...
*"A good architecture isn't about avoiding failure, it's about recovering from it."*
